...
public:
	...
	DECLARE_GLOBAL_SHADER(FMSPComputeShader);
	SHADER_USE_PARAMETER_STRUCT(FMSPComputeShader, FGlobalShader);


	class FMSPComputeShader_Perm_TEST : SHADER_PERMUTATION_INT("TEST", 1);
	using FPermutationDomain = TShaderPermutationDomain<
		FMSPComputeShader_Perm_TEST
	>;
...
public:
	...
	static void ModifyCompilationEnvironment(const FGlobalShaderPermutationParameters& Parameters, FShaderCompilerEnvironment& OutEnvironment)
	{
		...
		*/
		OutEnvironment.SetDefine(TEXT("THREADS_X"), NUM_THREADS_MSPComputeShader_X);
		OutEnvironment.SetDefine(TEXT("THREADS_Y"), NUM_THREADS_MSPComputeShader_Y);
		OutEnvironment.SetDefine(TEXT("THREADS_Z"), NUM_THREADS_MSPComputeShader_Z);
...
IMPLEMENT_GLOBAL_SHADER(FMSPComputeShader, "/LargeBufferShaderShaders/MSPComputeShader.usf", "MSPComputeShader", SF_Compute);

void FMSPComputeShaderInterface::DispatchRenderThread(FRHICommandListImmediate& RHICmdList, FMSPComputeShaderDispatchParams Params, TFunction<void(int OutputVal)> AsyncCallback) {
...

	{
		...
		// PermutationVector.Set<FMSPComputeShader::FMyPermutationName>(12345);

		TShaderMapRef<FMSPComputeShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel), PermutationVector);


		bool bIsShaderValid = ComputeShader.IsValid();

		if (bIsShaderValid) {
			FMSPComputeShader::FParameters* PassParameters = GraphBuilder.AllocParameters<FMSPComputeShader::FParameters>();
			...
			FRHIGPUBufferReadback* GPUBufferReadback = new FRHIGPUBufferReadback(TEXT("ExecuteMSPComputeShaderOutput"));
